    ...
    callback: async (client, interaction) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                ...
                "**Super Shadow:**\n" +
                "When the Chaos Emeralds answer my call, I ascend. My fur turns to gold white, and I become an unstoppable force of destruction. In this form, I have teleported massive space colonies, battled biolizard monstrosities, and defied gravity itself. I am the storm that approaches. I am the end of the line.\n\n" +
