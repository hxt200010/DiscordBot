...
module.exports = {
    ...
    callback: async (client, interaction) => {
        ...
        // Check Lucky Charm
        const stealerInventory = await economySystem.getInventory(stealerId);
        ...
        if (random < successChance) {
            ...
            await economySystem.removeBalance(targetId, amount);
            await economySystem.addBalance(stealerId, amount);
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    { name: 'Your Balance', value: `$${await economySystem.getBalance(stealerId)}`, inline: true },
                    { name: 'Victim Balance', value: `$${await economySystem.getBalance(targetId)}`, inline: true }
                );
            ...
            await economySystem.removeBalance(stealerId, fine);
